    ...
    <footer className='w-full bg-secondaryColor p-3'>
        ...
        <div className=" w-60 p-4">
            ...
            <div className="p-5"> 
                ...
                <a className="my-3 font-semibold block hover:font-extrabold transition duration-150 ease-in-out hover:text-primaryColor hover:cursor-pointer" onClick={() => handleRouting("appointments")}>Manage Appointments</a>
                <a className="my-3 font-semibold block hover:font-extrabold transition duration-150 ease-in-out hover:text-primaryColor hover:cursor-pointer" onClick={() => handleRouting("patients")}>Patient Records</a>
            </div>
            <div className="p-5">
